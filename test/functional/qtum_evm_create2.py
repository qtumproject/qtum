...
class QtumEVMCreate2Test(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-logevents', '-minmempoolgaslimit=21000', '-constantinopleheight=%d' % (204 + COINBASE_MATURITY), '-muirglacierheight=100000', '-londonheight=1000000', '-shanghaiheight=1000000', '-cancunheight=100000', '-pectraheight=100000', '-osakaheight=100000']]
