...
class RPCGenerateTest(BitcoinTestFramework):
    ...
    def test_generatetoaddress(self):
        self.generatetoaddress(self.nodes[0], 1, convert_btc_address_to_qtum('mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ'))
    ...
    def test_generateblock(self):
        ...
        for _ in range(10):
            miniwallet.send_self_transfer(from_node=node, fee_rate=Decimal("0.004"))

        self.log.info('Generate block with txid')
        txid = miniwallet.send_self_transfer(from_node=node, fee_rate=Decimal("0.004"))['txid']
        ...
        txid1 = miniwallet.send_self_transfer(from_node=node, fee_rate=Decimal("0.004"))['txid']
