...
class ZMQTest (BitcoinTestFramework):
    ...
    def test_basic(self):
        ...
        genhashes = self.nodes[0].generatetoaddress(num_blocks, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))
        ...
        if self.is_wallet_compiled():
            ...
            self.nodes[0].generatetoaddress(1, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))
            hashtx.receive()
            txid = hashtx.receive()
            assert_equal(payment_txid, txid.hex())
    ...
    def test_reorg(self):
        ...
        disconnect_block = self.nodes[0].generatetoaddress(1, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))[0]
        ...
        connect_blocks = self.nodes[1].generatetoaddress(2, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_P2WSH_OP_TRUE))
    ...
    def test_sequence(self):
        ...
        dc_block = self.nodes[0].generatetoaddress(1, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))[0]

        # Note: We are not notified of any block transactions, coinbase or mined
        assert_equal((self.nodes[0].getbestblockhash(), "C", None), seq.receive_sequence())

        # Generate 2 blocks in nodes[1] to a different address to ensure a chain split
        self.nodes[1].generatetoaddress(2, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_P2WSH_OP_TRUE))
        ...
        if self.is_wallet_compiled():
            ...
            c_block = self.nodes[0].generatetoaddress(1, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))[0]
            self.sync_all()
            ...
            self.nodes[1].generatetoaddress(1, convert_btc_bech32_address_to_qtum(ADDRESS_BCRT1_UNSPENDABLE))
            self.sync_all()
