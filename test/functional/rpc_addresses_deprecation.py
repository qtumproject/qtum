...
class AddressesDeprecationTest(BitcoinTestFramework):
    ...
    def test_addresses_deprecation(self):
        ...
        assert_equal(script_pub_key['addresses'], [convert_btc_address_to_qtum('mvKDK6D54HU8wQumJBLHY95eq5iHFqXSBz'), convert_btc_address_to_qtum('mv3rHCQSwKp2BLSuMHD8uCS32LW5xiNAA5'), convert_btc_address_to_qtum('mirrsyhAQYzo5CwVhcaYJKwUJu1WJRCRJe')])
