...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"qtum-cli -h\" for help or \"qtum-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and qtum-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and qtum-cli getwalletinfo return expected wallet info")
