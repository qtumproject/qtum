...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_locked_wallet(self):
        ...
        inputs = []
        outputs = {self.nodes[0].getnewaddress():1.09922}
        ...
        rawtx = self.nodes[1].createrawtransaction(inputs, outputs)
        assert_raises_rpc_error(-4, "Transaction needs a change address, but we can't generate it.", self.nodes[1].fundrawtransaction, rawtx, {"change_type": "bech32"})
    ...
    def test_transaction_too_large(self):
        ...
        outputs = {}
        rawtx = recipient.createrawtransaction([], {wallet.getnewaddress(): 143.99899260})
