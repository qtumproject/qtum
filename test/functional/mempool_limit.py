...
class MempoolLimitTest(BitcoinTestFramework):
    ...
    def test_rbf_carveout_disallowed(self):
        ...
        tx_A = self.wallet.send_self_transfer(
            from_node=node,
            fee=(mempoolmin_feerate / 1000) * (A_weight // 4) + Decimal('0.00001'),
        ...
        tx_C = self.wallet.create_self_transfer(
            ...
            fee = (mempoolmin_feerate / 1000) * (non_cpfp_carveout_weight // 4) + Decimal('0.0001'),
    ...
    def test_mid_package_eviction(self):
        ...
        mempool_evicted_tx = self.wallet.send_self_transfer(
            from_node=node,
            fee=(mempoolmin_feerate / 1000) * (evicted_weight // 4) + Decimal('0.0001'),
        ...
        parent_fee = (100 * mempoolmin_feerate / 10000) * (parent_weight // 4)
    ...
    def run_test(self):
        ...
        tx_child = miniwallet.create_self_transfer_multi(utxos_to_spend=coins, fee_per_output=1000000)
        ...
        assert_equal(child_result["fees"]["base"], Decimal("0.01000000"))
