...
BASE_SCRIPTS = [
    ...
    'qtum_pos.py --descriptors',
    'qtum_opcall.py --legacy-wallet',
    'qtum_opcall.py --descriptors',
    'qtum_opcreate.py --legacy-wallet',
    'qtum_opcreate.py --descriptors',
    'qtum_8mb_block.py --legacy-wallet',
    'qtum_8mb_block.py --descriptors',
    'qtum_gas_limit.py --legacy-wallet',
    'qtum_gas_limit.py --descriptors',
    'qtum_searchlog.py --legacy-wallet',
    'qtum_searchlog.py --descriptors',
    'qtum_pos_segwit.py --legacy-wallet',
    'qtum_pos_segwit.py --descriptors',
    'qtum_state_root.py --legacy-wallet',
    'qtum_state_root.py --descriptors',
    'qtum_evm_globals.py --legacy-wallet',
    'qtum_evm_globals.py --descriptors',
    'qtum_null_sender.py --legacy-wallet',
    'qtum_null_sender.py --descriptors',
    'qtum_waitforlogs.py --legacy-wallet',
    'qtum_waitforlogs.py --descriptors',
    'qtum_block_header.py --legacy-wallet',
    'qtum_block_header.py --descriptors',
    'qtum_callcontract.py --legacy-wallet',
    'qtum_callcontract.py --descriptors',
    'qtum_spend_op_call.py --legacy-wallet',
    'qtum_spend_op_call.py --descriptors',
    'qtum_condensing_txs.py --legacy-wallet',
    'qtum_condensing_txs.py --descriptors',
    'qtum_createcontract.py --legacy-wallet',
    'qtum_createcontract.py --descriptors',
    'qtum_sendtocontract.py --legacy-wallet',
    'qtum_sendtocontract.py --descriptors',
    'qtum_identical_refunds.py --legacy-wallet',
    'qtum_identical_refunds.py --descriptors',
    'qtum_create_eth_op_code.py --legacy-wallet',
    'qtum_create_eth_op_code.py --descriptors',
    'qtum_gas_limit_overflow.py --legacy-wallet',
    'qtum_gas_limit_overflow.py --descriptors',
    'qtum_call_empty_contract.py --legacy-wallet',
    'qtum_call_empty_contract.py --descriptors',
    'qtum_dgp_block_size_sync.py --legacy-wallet',
    'qtum_dgp_block_size_sync.py --descriptors',
    'qtum_pos_conflicting_txs.py --legacy-wallet',
    'qtum_pos_conflicting_txs.py --descriptors',
    'qtum_globals_state_changer.py --legacy-wallet',
    'qtum_globals_state_changer.py --descriptors',
    'qtum_no_exec_call_disabled.py --legacy-wallet',
    'qtum_no_exec_call_disabled.py --descriptors',
    'qtum_soft_block_gas_limits.py --legacy-wallet',
    'qtum_soft_block_gas_limits.py --descriptors',
    'qtum_dgp_block_size_restart.py --legacy-wallet',
    'qtum_dgp_block_size_restart.py --descriptors',
    'qtum_searchlog_restart_node.py --legacy-wallet',
    'qtum_searchlog_restart_node.py --descriptors',
    'qtum_immature_coinstake_spend.py --legacy-wallet',
    'qtum_immature_coinstake_spend.py --descriptors',
    'qtum_transaction_prioritization.py --legacy-wallet',
    'qtum_transaction_prioritization.py --descriptors',
    'qtum_assign_mpos_fees_to_gas_refund.py --legacy-wallet',
    'qtum_assign_mpos_fees_to_gas_refund.py --descriptors',
    'qtum_ignore_mpos_participant_reward.py --legacy-wallet',
    'qtum_ignore_mpos_participant_reward.py --descriptors',
    'qtum_evm_constantinople_activation.py --legacy-wallet',
    'qtum_evm_constantinople_activation.py --descriptors',
    'qtum_many_value_refunds_from_same_tx.py --legacy-wallet',
    'qtum_many_value_refunds_from_same_tx.py --descriptors',
    'qtum_combined_outputs_exceed_gas_limit.py --legacy-wallet',
    'qtum_combined_outputs_exceed_gas_limit.py --descriptors',
    'qtum_dgp_gas_price_lingering_mempool_tx.py --legacy-wallet',
    'qtum_dgp_gas_price_lingering_mempool_tx.py --descriptors',
    'qtum_dgp_gas_schedule.py --legacy-wallet',
    'qtum_dgp_gas_schedule.py --descriptors',
    'qtum_header_spam.py --dos-same-height --legacy-wallet',
    'qtum_header_spam.py --dos-variable-height --legacy-wallet',
    'qtum_header_spam.py --run-standard-tests --legacy-wallet',
    'qtum_header_spam.py --dos-same-height --descriptors',
    'qtum_header_spam.py --dos-variable-height --descriptors',
    'qtum_header_spam.py --run-standard-tests --descriptors',
    'qtum_divergence_dos.py --legacy-wallet',
    'qtum_divergence_dos.py --descriptors',
    'qtum_prioritize_create_over_call.py --legacy-wallet',
    'qtum_prioritize_create_over_call.py --descriptors',
    'qtum_callcontract_timestamp.py --legacy-wallet',
    'qtum_callcontract_timestamp.py --descriptors',
    'qtum_transaction_receipt_origin_contract_address.py --legacy-wallet',
    'qtum_transaction_receipt_origin_contract_address.py --descriptors',
    'qtum_block_number_corruption.py --legacy-wallet',
    'qtum_block_number_corruption.py --descriptors',
    'qtum_duplicate_stake.py --legacy-wallet',
    'qtum_duplicate_stake.py --descriptors',
    'qtum_rpc_bitcore.py --legacy-wallet',
    'qtum_rpc_bitcore.py --descriptors',
    'qtum_faulty_header_chain.py --legacy-wallet',
    'qtum_faulty_header_chain.py --descriptors',
    'qtum_signrawsender.py --legacy-wallet',
    'qtum_op_sender.py --legacy-wallet',
    'qtum_evm_revert.py --legacy-wallet',
    'qtum_evm_revert.py --descriptors',
    'qtum_evm_create2.py --legacy-wallet',
    'qtum_evm_create2.py --descriptors',
    'qtum_evm_staticcall.py --legacy-wallet',
    'qtum_evm_staticcall.py --descriptors',
    'qtum_evm_constantinople_precompiles.py --legacy-wallet',
    'qtum_evm_constantinople_precompiles.py --descriptors',
    'qtum_evm_constantinople_opcodes.py --legacy-wallet',
    'qtum_evm_constantinople_opcodes.py --descriptors',
    'qtum_evm_pectra_precompiles.py --legacy-wallet',
    'qtum_evm_pectra_precompiles.py --descriptors',
    'qtum_block_index_cleanup.py --legacy-wallet',
    'qtum_block_index_cleanup.py --descriptors',
    'qtum_pod.py --legacy-wallet',
    'qtum_simple_delegation_contract.py --legacy-wallet',
    'qtum_delegation_contract.py --legacy-wallet',
    'qtum_qrc20.py --legacy-wallet',
]
