...
class BIP66Test(BitcoinTestFramework):
    ...
    def create_tx(self, input_txid):
        ...
        return self.miniwallet.create_self_transfer(fee_rate=Decimal("0.01"), from_node=self.nodes[0], utxo_to_spend=utxo_to_spend)['tx']
    ...
    def run_test(self):
        ...
        self.log.info("Mining %d blocks", 2100)
        self.coinbase_txids = [self.nodes[0].getblock(b)['tx'][0] for b in self.miniwallet.generate(100)]
        self.miniwallet.generate(2000)
