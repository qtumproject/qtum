...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/qtum.conf}
...
then
  ...
  echo -e "To safely generate a qtum.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example qtum.conf file in share/examples/'
