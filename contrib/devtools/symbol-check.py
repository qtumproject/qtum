...
'GLIBC': {
    ...
    lief.ELF.ARCH.x86_64: (2,25),
    lief.ELF.ARCH.ARM:    (2,25),
    lief.ELF.ARCH.AARCH64:(2,25),
    lief.ELF.ARCH.PPC64:  (2,25),
...
'__bss_end__', '_fini', '_IO_stdin_used', 'stdin', 'stdout', 'stderr', 'in6addr_any',
