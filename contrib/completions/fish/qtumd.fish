...
complete --command qtumd --no-files

# Extract options
function __fish_qtumd_get_options
...
complete \
    --command qtumd \
    --arguments "(__fish_qtumd_get_options --nofiles)"
