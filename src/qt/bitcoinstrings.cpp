...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Dumpfile version is not supported. This version of qtum-wallet only supports version 1 dumpfiles. Got dumpfile with version %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Not all address book records were migrated"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Invalid percentage value for -stakingminfee=<n>: '%d' (must be between 0 and 100)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Signing transaction output failed"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "You need to rebuild the database using -reindex to change -addrindex"),
QT_TRANSLATE_NOOP("bitcoin-core", "You need to rebuild the database using -reindex to enable -logevents"),
