...
QtumPushButton::QtumPushButton(QWidget* parent) : QPushButton(parent),
                                                  m_iconCached(false)
{
}

QtumPushButton::QtumPushButton(const QString& text, QWidget* parent) : QPushButton(text, parent),
                                                                       m_iconCached(false)
{
}
