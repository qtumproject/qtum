    ...
    tab(_tab)
{
    ...
    if (!platformStyle->getImagesOnButtons()) {
        ...
        //ui->newAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/add", PlatformStyle::PushButton, 0x5a5a5d));//QTUM_CHECK
        //ui->copyAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/editcopy", PlatformStyle::PushButton, 0x5a5a5d));//QTUM_CHECK
        //ui->deleteAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/remove", PlatformStyle::PushButton, 0x5a5a5d));//QTUM_CHECK
        //ui->exportButton->setIcon(platformStyle->MultiStatesIcon(":/icons/export", PlatformStyle::PushButton));//QTUM_CHECK
    }
