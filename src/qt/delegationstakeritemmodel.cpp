...
public:
    ...
    DelegationStakerItemPriv(DelegationStakerItemModel* _parent) : parent(_parent) {}
...
DelegationStakerItemModel::DelegationStakerItemModel(WalletModel* parent) : QAbstractItemModel(parent),
                                                                            walletModel(parent),
                                                                            priv(0)
{
...
public:
    ...
    DelegationStakerNotification(uint160 _hash, ChangeType _status, bool _showDelegationStaker) : hash(_hash), status(_status), showDelegationStaker(_showDelegationStaker) {}
