...
public:
     ...
     */
    bool searchTokenTx(interfaces::Node& node, const WalletModel* wallet_model, int64_t fromBlock, int64_t toBlock, int64_t minconf, std::string strContractAddress, std::string strSenderAddress, QVariant& result);
