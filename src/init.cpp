...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-headerspamfiltermaxsize=<n>", strprintf("Maximum size of the list of indexes in the header spam filter (default: %u)", GefaultHeaderSpamFilterMaxSize()), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
