...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_type: {ChainType::MAIN, ChainType::TESTNET, ChainType::TESTNET4, ChainType::SIGNET, ChainType::UNITTEST}) {
...

    {
        ...
        const auto chainParams = CreateChainParams(args, ChainType::UNITTEST);
