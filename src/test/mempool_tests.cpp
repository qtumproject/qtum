...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    tx1.vout[0].nValue = 10 * COIN;
    pool.addUnchecked(tx1.GetHash(), entry.Fee(100000).FromTx(tx1, &pool));
    ...
    pool.addUnchecked(tx2.GetHash(), entry.Fee(50000).FromTx(tx2, &pool));
    ...
    pool.addUnchecked(tx3.GetHash(), entry.Fee(200000).FromTx(tx3, &pool));
    ...
    pool.addUnchecked(tx4.GetHash(), entry.Fee(70000).FromTx(tx4, &pool));
    pool.addUnchecked(tx5.GetHash(), entry.Fee(10000).FromTx(tx5, &pool));
    pool.addUnchecked(tx6.GetHash(), entry.Fee(11000).FromTx(tx6, &pool));
    pool.addUnchecked(tx7.GetHash(), entry.Fee(90000).FromTx(tx7, &pool));
