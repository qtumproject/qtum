...
BOOST_AUTO_TEST_CASE(bytecodeexec_create_contract){
    ...
    txEth = QtumTransaction(0, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), code, dev::u256(0));
    txEth.forceSender(dev::Address("0101010101010101010101010101010101010101"));
    txEth.setHashWith(dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
    txEth.setNVout(0);
...
BOOST_AUTO_TEST_CASE(bytecodeexec_OutOfGasBase_create_contract_normal_create_contract){
    ...
    std::vector<QtumTransaction> txs;
    dev::h256 hash(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
...
BOOST_AUTO_TEST_CASE(bytecodeexec_call_contract_transfer){
    ...
    valtype code(ParseHex("6060604052346000575b60398060166000396000f30060606040525b600b5b5b565b0000a165627a7a723058208dcf9e9f355ea43af9d928d96e2197200e046d281d2e701af1027acf35415c100029"));
    txEthCreate = QtumTransaction(0, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), code, dev::u256(0));
    txEthCreate.forceSender(dev::Address("0101010101010101010101010101010101010101"));
    txEthCreate.setHashWith(dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
    ...
    txEthCall = QtumTransaction(1300, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), newAddress, codeCall, dev::u256(0));
    txEthCall.forceSender(dev::Address("0101010101010101010101010101010101010101"));
    txEthCall.setHashWith(dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
...
BOOST_AUTO_TEST_CASE(bytecodeexec_call_contract_transfer_many){
    ...
    QtumTransaction txEthCall;
    valtype codeCall(ParseHex("00"));
    dev::h256 hashCall = dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
    for(size_t i = 0; i < txs.size(); i++){
        txEthCall = QtumTransaction(1300 + i, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), newAddressGen[i], codeCall, dev::u256(0));
        txEthCall.forceSender(dev::Address("0101010101010101010101010101010101010101"));
...
BOOST_AUTO_TEST_CASE(bytecodeexec_suicide){
    ...
    for(size_t i = 0; i < 10; i++){
        ...
        if(i == 0){
            ...
            txEthCreate = QtumTransaction(13, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), code, dev::u256(0));
        }
        txEthCreate.forceSender(dev::Address("0101010101010101010101010101010101010101"));
    ...
    for(size_t i = 0; i < txsCreate.size() - 1; i++){
        txEthCall = QtumTransaction(0, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), newAddresses[i + 1], codeCall, dev::u256(0));
        txEthCall.forceSender(dev::Address("0101010101010101010101010101010101010101"));
        txEthCall.setHashWith(dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
        txEthCall.setNVout(0);
...
BOOST_AUTO_TEST_CASE(bytecodeexec_contract_create_contracts){
    ...
    for(size_t i = 0; i < 20; i++){
        txEthCall = QtumTransaction(0, dev::u256(500000), (dev::u256(500000) * dev::u256(1)), newAddress, codeCall, dev::u256(0));
        txEthCall.forceSender(dev::Address("0101010101010101010101010101010101010101"));
        txEthCall.setHashWith(dev::h256(ParseHex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")));
        txEthCall.setNVout(i);
        txsCall.push_back(txEthCall);
