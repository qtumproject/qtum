...
bool VerifySignature(const Coin& coin, Txid txFromHash, const CTransaction& txTo, unsigned int nIn, script_verify_flags flags);
bool VerifySignature(const CScript& fromPubKey, Txid txFromHash, const CTransaction& txTo, unsigned int nIn, script_verify_flags flags);
