...
public:
    ...
    virtual bool SignTransactionOutput(CMutableTransaction& tx, std::map<int, std::string>& output_errors) const { return false; }
...
public:
    ...
    bool SignTransactionOutput(CMutableTransaction& tx, std::map<int, std::string>& output_errors) const override;
