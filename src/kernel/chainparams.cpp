...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            ...
            .nTime    = 1677137204, // * UNIX timestamp of last known number of transactions
            .nTxCount = 9233597, // * total number of transactions between genesis and that timestamp
            .dTxRate  = 0.07037814963941287, // * estimated number of transactions per second after that timestamp
        };
