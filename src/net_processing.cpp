...
{
    {
        ...
        if (!fReindex && !fImporting && pblock->IsProofOfStake() && (setStakeSeen.count(pblock->GetProofOfStake()) && !mapBlockIndex.count(pblock->GetHash())) && !mapOrphanBlocksByPrev.count(hash))
