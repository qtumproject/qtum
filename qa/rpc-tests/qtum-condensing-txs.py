...
class CondensingTxsTest(BitcoinTestFramework):
    ...
    def setup_contracts(self):
        ...
        self.sender1 = self.node.createcontract(sender1_bytecode)['address']
        ...
        self.sender2 = self.node.createcontract(sender2_bytecode)['address']
        ...
        self.sender3 = self.node.createcontract(sender3_bytecode)['address']
    ...
    def run_test(self):
        ...
        assert_vin(C2, [('OP_TXHASH', ), ('OP_TXHASH', )])
        assert_vout(C2, [(7, 'call')])
        assert_vin(C3, [('OP_TXHASH', ), ('OP_TXHASH', ), ('OP_TXHASH', )])
        ...
        assert_vin(C4, [('OP_TXHASH', ), ('OP_TXHASH', )])
