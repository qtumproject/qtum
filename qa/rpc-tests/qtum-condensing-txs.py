...
class CondensingTxsTest(BitcoinTestFramework):
    ...
    def setup_contracts(self):
        ...
        self.sender1 = self.node.createcontract(sender1_bytecode, 1000000, 0.00000001)['address']
        ...
        self.sender2 = self.node.createcontract(sender2_bytecode, 1000000, 0.00000001)['address']
    ...
    def run_test(self):
        ...
        T4_raw = make_transaction(self.node, [make_vin(self.node, 3*COIN)], [make_op_call_output(2*COIN, 0x04, 22000, 1, hex_str_to_bytes(self.share_abi), hex_str_to_bytes(self.sender2))])
