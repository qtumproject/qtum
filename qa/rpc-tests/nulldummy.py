...
class NULLDUMMYTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        trueDummy(test2tx)
        assert_raises_message(JSONRPCException, NULLDUMMY_ERROR, self.nodes[0].sendrawtransaction, bytes_to_hex_str(test2tx.serialize_with_witness()), True)
        ...
        trueDummy(test4tx)
        assert_raises_message(JSONRPCException, NULLDUMMY_ERROR, self.nodes[0].sendrawtransaction, bytes_to_hex_str(test4tx.serialize_with_witness()), True)
        ...
        assert_raises_message(JSONRPCException, NULLDUMMY_ERROR, self.nodes[0].sendrawtransaction, bytes_to_hex_str(test5tx.serialize_with_witness()), True)
